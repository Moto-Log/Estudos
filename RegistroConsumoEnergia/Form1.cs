...
{
    public partial class RegistroConsumoDeEnergia : Form
    {
        //IList é uma coleção de dados
        private IList<Leitura> leituras = new BindingList<Leitura>();
        //Um objeto que serve como fonte de dados para controles visuais
        private BindingSource leituraSource = new BindingSource();

        public RegistroConsumoDeEnergia()
        {
            InitializeComponent();
        ...
        private void ProcessarLeituras(DataGridView dgv)
        {
            ...
            lblTotalSemDesconto.Text = (totalConsumo - totalDesconto).ToString("N");
        }
